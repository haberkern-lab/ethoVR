...
A guide on modifying this projector for use in the ethoVR can be found [here](https://haberkernlab.github.io/ethoVR/assets/otherdocs/TI DLPDLC3010EVM-G2 modification guide.pdf).
