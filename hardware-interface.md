...
### Tracking camera
We illuminated the ball in infrared and used a high-speed camera (Grasshopper3 GS3-U3-23S6M, 2.3 MP, Teledyne FLIR, Wilsonville, OR, USA) to film the ball at a slightly higher frame rate than the intended frame rate of the VR system (the frame rate of the display). In our hands, a frame rate of 150 Hz worked well, but higher frame rates occasionally caused delays in the image processing and consequently in delayed VR updates. As an alternative, cheeper camera we recommend [Basler dart M dmA1440-73gm (Mono)](https://www.baslerweb.com/de-de/shop/bundle-dma1440-73g/). As a cost-effective lense, we recommend [Raspberry Pi SC0123](https://www.mouser.de/ProductDetail/Raspberry-Pi/SC0123?qs=T%252BzbugeAwjj%252BWe5BsdDXkg%3D%3D).
...
An example settings file can be found [here](https://www.haberkernlab.de/ethoVR/assets/fictrac/grasshop_socket_config.txt).
...
![intro image](https://www.haberkernlab.de/ethoVR/assets/fictrac/fictrac-configImg.png)
